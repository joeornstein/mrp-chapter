...
MRP's performance depends heavily on the quality and size of the researcher's survey sample. Up to now, we've been working with a random sample of 1,000 respondents, and though the resulting estimates have outperformed the raw sample means, the performance has been somewhat underwhelming. Suppose instead we had a sample of 5,000 respondents.
...
Now MRP can really shine, because it
...
# find the marginal distribution for each additional variable
# ...
...
As a final demonstration, suppose we had access to the entire joint distribution over those covariates, *and* our first stage model was a Super Learner ensemble...
