...
compare_to_truth <- function(estimates, truth){
  ...
  labs(x = 'Estimate',
       y = 'Truth',
       caption = paste0('Correlation = ', round(cor(d$estimate, d$truth), 2), ', Mean Absolute Error = ', round(mean(abs(d$estimate - d$truth)), 2)))
}
...
A better approach is to estimate a multilevel model (alternatively known as "varying-intercepts" or "random effects" model), including group-level covariates ; Census division adding Biden vote share
